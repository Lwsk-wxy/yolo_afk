...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in {
            ...
            Bottleneck, SPP, SPPF, DWConv, BottleneckCSP, nn.ConvTranspose2d, DWConvTranspose2d, SPPCSPC, ADown,SE,
        ...
        # TODO: channel, gw, gd
            ...
            c2 = ch[f]
            args = [c1, *args]
        elif m in {C2f, DWConv, RepNCSPELAN4_CD_LSK,  C2f_CD_LSK}:
            c1 = ch[f]
            c2 = args[0]
            args = [c1, *args]
        elif m is RepNCSPELAN4_CD_LSK:
            c1 = ch[f]
            c2 = args[0]
            args = [c1, *args]
        elif m in {SCConv,}:
            ...
            c1 = ch[f]
            c2 = c1 if len(args) == 0 else args[0]
            args = [c1, c2, *args[1:]]
        elif m in (SPDConv,):
            args = [ch[f], ch[f]]
        else:
