...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/NEU.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/NEU-LSK-ack/weights/best_striped.pt', help='model path(s)')
