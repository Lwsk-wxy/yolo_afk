...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=r'G:/yolov9-main/yolov9-c.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='G:\yolov9-main\models\detect\yolov9-LSKattention.yaml', help='model.yaml path')
